...
| 2.AN.irq | **3-way ISR dispatch (TIMG0 + GPIO + TIMG1)** — TIMG1.intr → CLIC cause 20, ISR extended with third branch (cause 20 → toggle pin 10). 31-instruction ISR. Pin 8 @ 1 Hz (TIMG0), pin 9 on each rising edge (GPIO), pin 10 @ 2 Hz (TIMG1). FreeRTOS-style multi-source IRQ pattern fully working. | ✅ done | (this commit) | [phase_2an_irq.md](phase_2an_irq.md) |
| **next** | TBD: 2.AM.demo (Arduino Wire blob), 2.AM.irq, SPI master, WDT, real PWM, FreeRTOS (deferred) | ⏭️ choice | — | — |
