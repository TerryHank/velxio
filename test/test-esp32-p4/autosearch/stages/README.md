...
| 2.AA | **INT_TYPE filter + multi-pin wiring**: rising/falling-edge masks (regs 0x80-0x98), 8 pins (0-7) wired to CPU lines 18-25. Demo configures pin 0 RISING-only — fake button only fires CPU IRQ on press, not release (pulse semantics). | ✅ done | (this commit) | [phase_2aa_int_type_filter.md](phase_2aa_int_type_filter.md) |
| **next** | TBD: LEVEL_HIGH/LOW triggers, all 32-pin wiring, peripherals (LEDC PWM / I2C / SPI / ADC), or real FreeRTOS port (Phase 2.V deferred) | ⏭️ choice | — | — |
